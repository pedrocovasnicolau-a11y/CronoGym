...
function Row({ label, sub, value, onChange }) {
  return (
    <div
      className="card"
      style={{
...
export function SettingsScreen({ onTab, settings, setSettings }) {
  ...
  return (
    <>
      ...
      <div className="scroll-area" style={{ padding: '8px 16px 24px' }}>
        ...
        >
          La vibración requiere que el móvil tenga el sonido en silencio o vibración activada. El
          aviso sonoro funciona aunque el móvil esté en silencio.
        </div>
      </div>
