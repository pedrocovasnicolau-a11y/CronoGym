// Iconos de trazo mínimos — CronoGym

export const Icon = ({ children, size = 22, stroke = 'currentColor', fill = 'none', sw = 2 }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const IconHome = (p) => (
  <Icon {...p}>
    <path d="M3 11l9-7 9 7v10a1 1 0 0 1-1 1h-5v-6H9v6H4a1 1 0 0 1-1-1V11z" />
  </Icon>
);
...
export const IconTempo = (p) => (
  <Icon {...p}>
    <path d="M2 9v6M6 7v10M6 12h12M18 7v10M22 9v6" />
  </Icon>
);
